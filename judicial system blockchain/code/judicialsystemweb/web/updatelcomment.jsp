            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="lawyermenu.jsp">View All Cases</a></li>
   ...
   <%@page import="java.net.*,java.io.*,java.util.*"%>
    <div class="site-section section-6">
      <div class="container">
          ...
          <br>
          <h1 align="center">Update Comment</h1>
          <h2 align="center">Case ID: <%=request.getParameter("caseid")%></h2>
          <form name="updatelcomment2" method="get" action="">
          <table align="center">
              <input type="hidden" name="caseid" value="<%=request.getParameter("caseid")%>" />
              <tr>
                  <td>Enter Comment: </td>
                  <td><textarea name="lcomment" required ></textarea></td>
              </tr>
              ...
              if (request.getParameter("submit2")!=null)
              {
                  ...
                  String lcomment=request.getParameter("lcomment");
                ...
                try
                {
                    ...
                    oos.writeObject("UPDATELCOMMENT");
                    oos.writeObject(caseid);
                    oos.writeObject(lcomment);
                    ...
                    if (reply.equals("SUCCESS"))
                    {
                        ...
                        <%
                        response.sendRedirect("lawyerhome.jsp?msg=COMMENTUPDATED");
                    }
                    else
                    {
                         %>
