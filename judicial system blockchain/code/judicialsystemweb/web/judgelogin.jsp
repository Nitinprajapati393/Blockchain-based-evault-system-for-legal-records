            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="judgelogin.jsp" >Judge Login</a></li>
  ...
  <%
    ...
    <div class="site-section section-6">
      <div class="container">
          ...
          <h1 align="center">Judge Login</h1>
          <br>
    <form name="judgelogin" method="post" action="judgelogin">
    ...
    <br>
    <p align="center">
    <a href="judgeregister.jsp">!!Click Here for Judge Registration!!</a> 
    </p>
