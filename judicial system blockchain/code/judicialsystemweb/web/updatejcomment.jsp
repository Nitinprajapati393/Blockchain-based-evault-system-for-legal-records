    ...
    <div class="site-section section-6">
      <div class="container">
          ...
          <table align="center">
              ...
              <tr>
                  <td>Enter Comment: </td>
                  <td><textarea name="jcomment" required ></textarea></td>
              </tr>
              ...
              if (request.getParameter("submit2")!=null)
              {
                  ...
                  String jcomment=request.getParameter("jcomment");
                ...
                try
                {
                    ...
                    oos.writeObject("UPDATEJCOMMENT");
                    oos.writeObject(caseid);
                    oos.writeObject(jcomment);
                    ...
                    if (reply.equals("SUCCESS"))
                    {
                        ...
                        <%
                        response.sendRedirect("judgehome.jsp?msg=COMMENTUPDATED");
                    }
                    else
                    {
                         %>
