            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="judgehome.jsp">View All Cases</a></li>
                        ...
                        for (int i=0;i<v.size();i++)
                        {
                            ...
                            while (st.hasMoreTokens())
                            {
                                ...
                                <tr>
                                    ...
                                    <td><a href="sendotp2?caseid=<%=caseid%>&fname=<%=fname%>"><%=fname%></a></td>
                                    <td>
                                        <form name="updatejcomment" method=get action="updatejcomment.jsp">
                                            <input type="hidden" name="caseid" value="<%=caseid%>" />
                                            <input type="submit" name="submit" value="Update Comment" />
                                        </form>
                                    </td>
                                    <td>
                                        <form name="updatestatus" method=get action="updatestatus.jsp">
                                            <input type="hidden" name="caseid" value="<%=caseid%>" />
