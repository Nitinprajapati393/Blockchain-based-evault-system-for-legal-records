            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="lawyerlogin.jsp">Lawyer Login</a></li>
  ...
  <%
    ...
    <div class="site-section section-6">
      <div class="container">
          ...
          <br>
    <form name="lawyerlogin" method="post" action="lawyerlogin">
    ...
    <br>
    <p align="center">
    <a href="lawyerregister.jsp">!!Click Here for Lawyer Registration!!</a> 
    </p>
